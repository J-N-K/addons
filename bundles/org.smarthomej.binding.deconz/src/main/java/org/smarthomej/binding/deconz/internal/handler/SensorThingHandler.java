...
public class SensorThingHandler extends SensorBaseThingHandler {
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES = Set.of(
            THING_TYPE_DAYLIGHT_SENSOR,
            THING_TYPE_ALARM_SENSOR, THING_TYPE_BATTERY_SENSOR,
    ...
    public static final Set<ThingTypeUID> DEPRECATED_THING_TYPES = Set.of(THING_TYPE_FIRE_SENSOR,
            ...
            THING_TYPE_MOISTURE_SENSOR, THING_TYPE_VIBRATION_SENSOR, THING_TYPE_PRESENCE_SENSOR,
            THING_TYPE_CARBONMONOXIDE_SENSOR, THING_TYPE_PRESSURE_SENSOR, THING_TYPE_AIRQUALITY_SENSOR, THING_TYPE_OPENCLOSE_SENSOR, THING_TYPE_WATERLEAKAGE_SENSOR, THING_TYPE_SWITCH, THING_TYPE_POWER_SENSOR, THING_TYPE_CONSUMPTION_SENSOR);
