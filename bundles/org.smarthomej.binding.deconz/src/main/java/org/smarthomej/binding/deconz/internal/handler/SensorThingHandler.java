...
public class SensorThingHandler extends SensorBaseThingHandler {
    public static final Set<ThingTypeUID> SUPPORTED_THING_TYPES = Set.of(
            THING_TYPE_DAYLIGHT_SENSOR, THING_TYPE_LIGHT_SENSOR,
            THING_TYPE_PRESSURE_SENSOR,  THING_TYPE_OPENCLOSE_SENSOR,
    ...
    public static final Set<ThingTypeUID> DEPRECATED_THING_TYPES = Set.of(THING_TYPE_FIRE_SENSOR,
            ...
            THING_TYPE_AIRQUALITY_SENSOR, THING_TYPE_WATERLEAKAGE_SENSOR, THING_TYPE_SWITCH, THING_TYPE_POWER_SENSOR, THING_TYPE_CONSUMPTION_SENSOR);
